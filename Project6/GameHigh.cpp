...
void GameHigh::initText()
{
	this->Font.loadFromFile("File/font.ttf");
}

void GameHigh::initMenu()
{
...
void GameHigh::initBotton(float width, float height)
{
	//Font Style
...
GameHigh::GameHigh(float width, float height)
{
	this->initText();
	this->initMenu();
...
void GameHigh::update(float width, float height)
{
}

void GameHigh::render(sf::RenderWindow& target)
{
...
const sf::FloatRect GameHigh::botton1() const
{
	return this->menu[0].getGlobalBounds();
}

const sf::FloatRect GameHigh::botton2() const
{
	return this->menu[1].getGlobalBounds();
}

const sf::FloatRect GameHigh::botton3() const
{
	return this->menu[2].getGlobalBounds();
}

const sf::FloatRect GameHigh::botton4() const
{
